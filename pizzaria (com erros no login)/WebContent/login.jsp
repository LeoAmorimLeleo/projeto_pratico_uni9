    ...
    <head>
        ...
        <script>
        	...
        	function autenticar(){ 
        		...
        		var json = {"email":email,"senha1":senha,"acao"}
        		$.ajax({
        		url:"UsrServlet",
        		data: json,
        		type "get",
                ...
                <div class="col-md-6 p-0 h-md-100 loginarea">
                    <div class="d-md-flex align-items-center h-md-100 p-3 justify-content-center">
                        <form action="UsrServlet" method="GET">
                            ...
                            <button type="submit" class="btn btn-dark btn-round btn-block" onClick="autenticar()">Entrar</button> <small class="d-block mt-4 text-center"><a class="text-gray" href="#">Esqueceu sua senha?</a></small>
