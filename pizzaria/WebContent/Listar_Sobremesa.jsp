    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-8"><h2><b>Listagem de sobremesas</b></h2></div><br><br>
                    <div class="col-md-12">
                    </div>
                </div>
            </div>
            <table class="table table-striped table table-bordered">
                    ...
                    <%
                        ArrayList<model.Sobremesa> lista3 = new ArrayList<model.Sobremesa>();
                        try{
                            
                            SobremesaDAO pDAO = new SobremesaDAO();
                            lista3 = pDAO.getLista();
                        }catch(Exception ex){
                            out.print(ex);
                        }
                        
                        for(Sobremesa p:lista3){
                    %>
                    <tr>
                        <td><%=p.getId()%></td>
                        <td><%=p.getNome()%></td>
