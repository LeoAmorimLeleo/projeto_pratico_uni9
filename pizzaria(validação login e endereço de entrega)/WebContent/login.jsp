...
<html lang="pt-br">    
    ...
    <body>
            ...
            <div class="d-md-flex h-md-100 align-items-center">
                ...
                <div class="col-md-6 p-0 h-md-100 loginarea">
                    <div class="d-md-flex align-items-center h-md-100 p-3 justify-content-center">
                         <form id="formlogin" action="UsrServlet" method="GET">
        ...
        <script src="./js/login.jsp"></script>
        ...
        <footer class="block footer1 footer text-center">©2021 - UNI9 Delivery de Pizza - Todos os direitos reservados</footer> 
        <script src="js/bootstrap.min.js"></script>
        <script src="https://unpkg.com/aos@2.3.1/dist/aos.js"></script>
        <script>
            AOS.init();
